...
function init() {
    ...
    // Earth terrain
    var earth_texture = new THREE.TextureLoader().load("./static/texture/earth.jpeg");
    var earth_bump = new THREE.TextureLoader().load("./static/texture/bump.jpeg");
    var earth_specular = new THREE.TextureLoader().load("./static/texture/spec.jpeg");
    ...
    scene.add(earth);
    // Earth cloud
    var cloud_texture = new THREE.TextureLoader().load('./static/texture/cloud.png');
